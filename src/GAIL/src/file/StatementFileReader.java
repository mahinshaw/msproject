...
public class StatementFileReader {
    ...
    public void readStatements(String fileName) {
         ...
         */
        ArgumentGenerator argGen = new ArgumentGenerator(xmlInterface.getGraph().getNodelist().get(6), reader.getArg(), reader.getArg().getQuestions().get(0), xmlInterface.getGraph().getNodelist());
        argGen.addArgument();
